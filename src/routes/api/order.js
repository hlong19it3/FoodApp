...
const { isRestaurantOwner, isUser, isShipper } = require('../../app/middleware/role')
...
router.post('/shipper-receive', checkToken, isShipper, orderController.shipperReceiveOrder)
router.post('/shipping', checkToken, isRestaurantOwner, orderController.shipping)
